...
var AUDIO_EVENTS = [
  ...
  { id: "hitMe",     label: "🎯 - 2️⃣",                    folder: "audio/hitMe",     files: makeFiles(31) }, // "🎯 Попадение по нам"
  { id: "sunkMe",    label: "⚓ - 1️⃣",                    folder: "audio/sunkMe",    files: makeFiles(30) }, // "⚓ Корабль потоплен наш"
